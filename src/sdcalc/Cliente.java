...
public class Cliente {
    public static void main(String[] args){
        ...
        try{
            ...
            Calculadora2 c2 = (Calculadora2)Naming.lookup("//localhost:1097/Calculadora2");
            ...
            while (true){
                ...
                switch(menu){
                    ...
                    case "5":{
                        ...
                        JOptionPane.showMessageDialog(null,"A raiz quadrada é: " + c2.raizQuad(x));
                        break;
                    }
                    case "6": {
                        float x = Integer.parseInt(JOptionPane.showInputDialog("Insira o primeiro numero:"));
                        float y = Integer.parseInt(JOptionPane.showInputDialog("Insira a porcentagem do número anterior a ser calculada (%):"));
